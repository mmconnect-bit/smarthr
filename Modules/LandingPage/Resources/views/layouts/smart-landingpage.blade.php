...
<head>
    ...
    <style>
        ...
        .feature-card-footer {
            margin-top: 1.5rem;
            padding-top: 1.5rem;
            border-top: 1px solid var(--smart-gray-200);
        }
...
<body class="{{ $themeColor }} smart-landing-page" data-theme="light">
                                    ...
                                    <div class="feature-card-modern {{ $key == 0 ? 'featured-highlight' : '' }}"
                                        ...
                                        <div class="feature-card-content">
                                            ...
                                            <div class="feature-action">
                                                <a href="#" class="btn-feature-learn">
                                    ...
                                    <div class="plan-header-modern">
                                        ...
                                        <div class="plan-price-modern">
                                            ...
                                            <div class="price-container yearly-price" style="display: none;">
                                                <span class="price-currency">Tsh</span>
                                                <span class="price-amount">{{ round($plan->price * 12 * 0.8) }}</span>
                                    ...
                                    <table class="table comparison-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @foreach($plans as $plan)
                                                    <td class="text-center">{{ $plan->storage_limit }}GB</td>
                                                @endforeach
                                            </tr>
                                            <tr>
    ...
    <a href="https://wa.me/255753417792?text=Hello! I'm interested in SmartHR. Can you please provide more information?"
            ...
            if (pricingToggle) {
                pricingToggle.addEventListener('click', function() {
                    ...
                    if (isYearly) {
                        ...
                        this.style.background = 'var(--smart-primary)';
                    } else {
                        slider.style.transform = 'translateX(0)';
                        this.style.background = 'var(--smart-gray-300)';
                    }
