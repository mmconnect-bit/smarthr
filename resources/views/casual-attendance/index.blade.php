    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['casual-attendance.index'], 'method' => 'get', 'id' => 'attendanceemployee_filter']) }}
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ route('casual-attendance.index') }}" class="btn btn-sm btn-danger "
                                       ...
                                       <!-- IMPORT BUTTON -->
                                        {{-- <a href="#"
                                            data-url="{{ route('attendance.file.import') }}"
                                            data-ajax-popup="true"
                                            data-title="{{ __('Import Attendance CSV File') }}"
                                        ...
                                        <!-- EXPORT BUTTON -->
                                        <a href="{{ route('casual-attendance.file.export') }}"
                                            data-bs-toggle="tooltip"
                                ...
                                @foreach ($attendanceEmployee as $attendance)
                                    <tr>
                                        ...
                                        <td>{{ $attendance->overtime }}</td>
                                         <td>{{ $attendance->activity?->activities?->name }}</td>
