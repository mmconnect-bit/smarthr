                            ...
                            <div class="card-body employee-detail-create-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo Form::text('biometric_emp_id', $employeesCode,[
                                            'class' => 'form-control',
                                            'readonly' => 'readonly',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mmconnect/Desktop/desktop/my project/SmartHR/irad.smarthr.co.tz/resources/views/employee/create.blade.php ENDPATH**/ ?>