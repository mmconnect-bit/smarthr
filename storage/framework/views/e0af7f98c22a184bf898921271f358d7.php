<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <?php endif; ?>
          ...
          <a href="<?php echo e(route('mainActivities.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('mainActivities*') ? 'active' : ''); ?>"><?php echo e(__('Main Activities')); ?>

            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
        </a>
        <a href="<?php echo e(route('activities.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('activities*') ? 'active' : ''); ?>"><?php echo e(__('Activities')); ?>
...
<?php /**PATH /home/mmconnect/Desktop/desktop/my project/SmartHR/irad.smarthr.co.tz/resources/views/layouts/hrm_setup.blade.php ENDPATH**/ ?>