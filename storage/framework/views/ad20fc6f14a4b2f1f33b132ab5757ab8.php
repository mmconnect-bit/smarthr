...
<head>
    ...
    <title><?php echo e($metatitle ?: env('APP_NAME') . ' - Smart HR Management Solution'); ?></title>

    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo e($metadesc ?: 'Professional HR Management System with Advanced Features for Modern Businesses'); ?>">
    ...
    <meta property="og:title" content="<?php echo e($metatitle ?: env('APP_NAME')); ?>">
    <meta property="og:description" content="<?php echo e($metadesc); ?>">
    <meta property="og:image" content="<?php echo e(isset($meta_logo) && !empty(asset('storage/uploads/meta/' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : asset('assets/images/default-og.png')); ?>">
    <meta property="og:site_name" content="<?php echo e(env('APP_NAME')); ?>">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="<?php echo e(env('APP_URL')); ?>">
    <meta property="twitter:title" content="<?php echo e($metatitle ?: env('APP_NAME')); ?>">
    <meta property="twitter:description" content="<?php echo e($metadesc); ?>">
    <meta property="twitter:image" content="<?php echo e(isset($meta_logo) && !empty(asset('storage/uploads/meta/' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : asset('assets/images/default-og.png')); ?>">

    <!-- Favicon -->
    <link rel="icon" href="https://smarthr.co.tz/storage/uploads/logo/favicon.png?v=<?php echo e(time()); ?>" type="image/png" />
    <link rel="apple-touch-icon" href="https://smarthr.co.tz/storage/uploads/logo/favicon.png?v=<?php echo e(time()); ?>" />
    <link rel="shortcut icon" href="https://smarthr.co.tz/storage/uploads/logo/favicon.png?v=<?php echo e(time()); ?>" type="image/png" />
    <link rel="apple-touch-icon" href="<?php echo e($sup_logo . '/' . (isset($adminSettings['company_favicon']) && !empty($adminSettings['company_favicon']) ? $adminSettings['company_favicon'] : 'favicon.png')); ?>">

    <!-- Preload Critical Resources -->
    <link rel="preload" href="<?php echo e(Module::asset('LandingPage:Resources/assets/fonts/tabler-icons.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="<?php echo e(Module::asset('LandingPage:Resources/assets/css/my-landing-styles.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    ...
    <link rel="stylesheet" href="<?php echo e(Module::asset('LandingPage:Resources/assets/css/my-landing-styles.css')); ?>" />

    <!-- Dynamic Color Variables -->
    <style>
        :root {
            --color-customColor: <?php echo e($color); ?>;
            --dynamic-primary: <?php echo e($setting['theme_color'] ?? '#6b7fff'); ?>;
            --smart-primary: <?php echo e($setting['theme_color'] ?? '#6b7fff'); ?>;
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "<?php echo e($metadesc ?: 'Professional HR Management System'); ?>",
...
<body class="<?php echo e($themeColor); ?> smart-landing-page" data-theme="light">
            ...
            <div class="announcement-bar bg-primary text-white text-center py-2">
                <div class="container">
                    <div class="announcement-content d-flex align-items-center justify-content-center">
                        ...
                        <span class="announcement-text"><?php echo $settings['topbar_notification_msg']; ?></span>
                        ...
                        <ul class="navbar-nav smart-nav mx-auto">
                            <li class="nav-item">
                                <a class="nav-link smart-nav-link active" href="#home" data-section="home">
                                    <span class="nav-text"><?php echo e($settings['home_title'] ?: 'Home'); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link smart-nav-link" href="#features" data-section="features">
                                    <span class="nav-text"><?php echo e($settings['feature_title'] ?: 'Features'); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link smart-nav-link" href="#pricing" data-section="pricing">
                                    <span class="nav-text"><?php echo e($settings['plan_title'] ?: 'Pricing'); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link smart-nav-link" href="#faq" data-section="faq">
                                    <span class="nav-text"><?php echo e($settings['faq_title'] ?: 'FAQ'); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                                    ...
                                    <?php if(isset($value->header) && $value->header == 'on' && isset($value->template_name)): ?>
                                        <li class="nav-item">
                                            <a class="nav-link smart-nav-link"
                                               href="<?php echo e($value->template_name == 'page_content' ? route('custom.page', $value->page_slug) : $value->page_url); ?>">
                                                <span class="nav-text"><?php echo e($value->menubar_page_name); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                            ...
                            <?php if(isset($adminSettings['disable_signup_button']) && $adminSettings['disable_signup_button'] == 'on'): ?>
                                <a href="<?php echo e(route('register')); ?>"
                                   ...
                                   aria-label="Create new account">
                                    <span class="btn-text d-none d-lg-inline"><?php echo e(__('Get Started')); ?></span>
    ...
    <main id="main-content" class="smart-main-content" role="main">
        ...
        <?php if($settings['home_status'] == 'on'): ?>
            <section class="smart-hero-section" id="home" aria-labelledby="hero-heading">
                ...
                <img src="<?php echo e(asset('assets/images/background-02.jpg')); ?>"
                     alt="Background"
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-xl-8">
                            <div class="hero-content text-center fade-in-up">
                                <?php if($settings['home_offer_text']): ?>
                                ...
                                <h1 id="hero-heading" class="hero-title mb-4">
                                    <?php echo e($settings['home_heading'] ?: 'SmartHR - HRM and Payroll Tool'); ?>

                                </h1>

                                <p class="hero-description mb-5">
                                    <?php echo e($settings['home_description'] ?: 'Use these awesome forms to login or create new account in your project for free. Streamline your HR processes with our intelligent, cloud-based platform designed for efficiency and growth.'); ?>
                                    ...
                                    <?php if($settings['home_buy_now_link']): ?>
                                        <a href="<?php echo e($settings['home_buy_now_link']); ?>"
                                           ...
                                           aria-label="Get started now">
                                            <span class="btn-text"><?php echo e(__('Get Started Free')); ?></span>
                    ...
                    <!-- Trusted By Section -->
                    <?php if($settings['home_trusted_by'] && $settings['home_logo']): ?>
                        <div class="trusted-by-section">
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="trusted-text mb-3">
                                        <span class="trusted-label"><?php echo e(__('Trusted by')); ?></span>
                                        <span class="trusted-count"><?php echo e($settings['home_trusted_by']); ?></span>
                                        <span class="trusted-suffix"><?php echo e(__('companies worldwide')); ?></span>
                                    </div>
                                            ...
                                            <?php $__currentLoopData = explode(',', $settings['home_logo']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $home_logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="logo-item">
                                                    <img src="<?php echo e($logo . '/' . $home_logo); ?>"
                                                         alt="Trusted Company Logo <?php echo e($k + 1); ?>"
                                                         class="trusted-logo"
                ...
                <div class="container">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="section-header">
                                <div class="section-badge pulse-badge mb-3">
                                    ...
                                    <span class="badge-text"><?php echo e($settings['feature_title'] ?: 'Why Choose Us'); ?></span>
                                </div>
                                <h2 id="features-heading" class="section-title gradient-text mb-4">
                                    <?php echo $settings['feature_heading'] ?: 'Powerful Features for <span class="highlight-text">Modern HR Management</span>'; ?>

                                </h2>
                                <p class="section-description lead">
                                    <?php echo $settings['feature_description'] ?: 'Unlock the full potential of your HR operations with our comprehensive suite of intelligent tools designed for efficiency, scalability, and growth.'; ?>
                    ...
                    <div class="row g-4 mb-5">
                        <?php if(is_array(json_decode($settings['feature_of_features'], true)) || is_object(json_decode($settings['feature_of_features'], true))): ?>
                            <?php $__currentLoopData = json_decode($settings['feature_of_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 col-md-6">
                                    <div class="feature-card-modern <?php echo e($key == 0 ? 'featured-highlight' : ''); ?>"
                                         data-aos="fade-up"
                                         data-aos-delay="<?php echo e($key * 150); ?>">
                                        <!-- Card Header -->
                                        <div class="feature-card-header">
                                            <div class="feature-icon-container">
                                                <div class="feature-icon-bg"></div>
                                                <img src="<?php echo e($logo . '/' . $feature['feature_logo'] . '?' . time()); ?>"
                                                     alt="<?php echo e($feature['feature_heading']); ?> icon"
                                        ...
                                        <div class="feature-card-footer">
                                            <div class="feature-stats">
                                                <div class="stat-item">
                                                    <span class="stat-number"><?php echo e(rand(95, 99)); ?>%</span>
                                                    <span class="stat-label">Satisfaction</span>
                                                </div>
                                                <div class="stat-item">
                                                    <span class="stat-number"><?php echo e(rand(100, 500)); ?>+</span>
        ...
        <?php if($settings['feature_status'] == 'on' && isset($settings['other_features'])): ?>
                ...
                <div class="container">
                    ...
                    <?php if(is_array(json_decode($settings['other_features'], true)) || is_object(json_decode($settings['other_features'], true))): ?>
                        <div class="additional-features-container">
                            <?php $__currentLoopData = json_decode($settings['other_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $otherFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="additional-feature-row <?php echo e($key % 2 == 0 ? 'standard' : 'reverse'); ?> mb-5">
                                    <div class="row align-items-center gy-5">
                                        <div class="col-lg-6 order-lg-<?php echo e($key % 2 == 0 ? '1' : '2'); ?>">
                                            <div class="feature-content-enhanced">
                                                <div class="feature-meta mb-3">
                                                    <div class="section-badge">
                                                        <span class="badge-text">Feature <?php echo e($key + 1); ?></span>
                                                    </div>
                                                    <div class="feature-category">
                                                        <?php echo e($key == 0 ? 'Automation' : ($key == 1 ? 'Analytics' : 'Integration')); ?>

                                                    </div>
                                                </div>

                                                <h3 class="feature-title-enhanced mb-4">
                                                    <?php echo isset($otherFeature['other_features_heading']) ? $otherFeature['other_features_heading'] : 'Advanced Feature Heading'; ?>

                                                </h3>

                                                <p class="feature-description-enhanced mb-4">
                                                    <?php echo isset($otherFeature['other_featured_description']) ? $otherFeature['other_featured_description'] : (isset($otherFeature['other_feature_description']) ? $otherFeature['other_feature_description'] : 'Discover how this powerful feature can transform your HR processes and improve organizational efficiency.'); ?>
                                                ...
                                                <div class="feature-stats mt-4">
                                                    <div class="row g-3">
                                                        <div class="col-4">
                                                            <div class="stat-box">
                                                                <div class="stat-number"><?php echo e(['95%', '80%', '500+'][$key % 3]); ?></div>
                                                                <div class="stat-label"><?php echo e(['Accuracy', 'Time Saved', 'Integrations'][$key % 3]); ?></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="stat-box">
                                                                <div class="stat-number"><?php echo e(['<5min', '24/7', '99.9%'][$key % 3]); ?></div>
                                                                <div class="stat-label"><?php echo e(['Setup Time', 'Availability', 'Uptime'][$key % 3]); ?></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="stat-box">
                                                                <div class="stat-number"><?php echo e(['4.9★', '1M+', 'SOC2'][$key % 3]); ?></div>
                                                                <div class="stat-label"><?php echo e(['Rating', 'Users', 'Compliant'][$key % 3]); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-6 order-lg-<?php echo e($key % 2 == 0 ? '2' : '1'); ?>">
                                            <div class="feature-visual-enhanced">
                                                <div class="visual-container">
                                                    <div class="visual-backdrop"></div>
                                                    <div class="visual-frame">
                                                        <img src="<?php echo e($logo . '/' . (isset($otherFeature['other_features_image']) ? $otherFeature['other_features_image'] : 'default.jpg')); ?>"
                                                             alt="<?php echo e(isset($otherFeature['other_features_heading']) ? strip_tags($otherFeature['other_features_heading']) : 'Feature'); ?>"
                                                        ...
                                                        <div class="visual-overlays">
                                                            <div class="overlay-element element-1">
                                                                <div class="element-content">
                                                                    <i class="ti ti-<?php echo e(['robot', 'chart-line', 'plug'][$key % 3]); ?>"></i>
                                                                    <span><?php echo e(['Smart AI', 'Analytics', 'Integration'][$key % 3]); ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="overlay-element element-2">
                                                                <div class="element-content">
                                                                    ...
                                                                    <span><?php echo e(['85%', '92%', '78%'][$key % 3]); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <?php if(isset($get_section)): ?>
            <?php $__currentLoopData = $get_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if ($__env->exists('landingpage::layouts.sections.' . $section->section_name, ['section' => $section])) echo $__env->make('landingpage::layouts.sections.' . $section->section_name, ['section' => $section], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>

        <!-- Pricing Section -->
        <!-- Enhanced Pricing Section -->
        <?php if($settings['plan_status'] == 'on' && isset($plans)): ?>
                ...
                <div class="container">
                        ...
                        <div class="col-lg-8 text-center">
                            <div class="section-header">
                                <div class="section-badge mb-3">
                                    ...
                                    <span class="badge-text"><?php echo e($settings['plan_title'] ?: 'Pricing Plans'); ?></span>
                                </div>
                    ...
                    <div class="row g-4 justify-content-center">
                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-md-6">
                                <div class="pricing-card-modern <?php echo e($key == 1 ? 'featured-plan' : ''); ?>"
                                     data-aos="fade-up"
                                     data-aos-delay="<?php echo e($key * 150); ?>">
                                    ...
                                    <div class="plan-header-modern">
                                        ...
                                        <h3 class="plan-name-modern"><?php echo e($plan->name); ?></h3>
                                        <p class="plan-subtitle"><?php echo e($plan->description ?: 'Perfect for getting started'); ?></p>
                                        ...
                                        <div class="plan-price-modern">
                                            ...
                                            <div class="price-container yearly-price" style="display: none;">
                                                <span class="price-currency">Tsh</span>
                                                <span class="price-amount"><?php echo e(number_format(round($plan->price * 12 * 0.8), 0, '.', ',')); ?></span>
                                    ...
                                    <div class="plan-features-modern">
                                        ...
                                        <ul class="features-list-modern">
                                            <li class="feature-item-modern">
                                                <i class="ti ti-check-circle text-success"></i>
                                                <span><strong><?php echo e($plan->max_users); ?></strong> Active Users</span>
                                            </li>
                                            <li class="feature-item-modern">
                                                <i class="ti ti-check-circle text-success"></i>
                                                <span><strong><?php echo e($plan->max_employees); ?></strong> Employee Records</span>
                                            </li>
                                            <li class="feature-item-modern">
                                                <i class="ti ti-check-circle text-success"></i>
                                                <span><strong><?php echo e($plan->storage_limit); ?>MB</strong> Secure Storage</span>
                                            </li>
                                            <li class="feature-item-modern">
                                                <i class="ti ti-check-circle text-success"></i>
                                    ...
                                    <div class="plan-action-modern">
                                        <a href="<?php echo e(route('register')); ?>"
                                           class="btn <?php echo e($key == 1 ? 'btn-primary' : ($key == 2 ? 'btn-success' : 'btn-outline-primary')); ?> btn-lg btn-plan">
                                            <?php if($key == 0): ?>
                                                <i class="ti ti-rocket me-2"></i>
                                                Start Free Trial
                                                 <?php elseif($key == 1): ?>
                                    ...
                                    <table class="table comparison-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td class="text-center"><?php echo e($plan->max_users); ?></td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <tr>
                                                <td><strong>Employees</strong></td>
                                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td class="text-center"><?php echo e($plan->max_employees); ?></td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <tr>
                                                <td><strong>Storage</strong></td>
                                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td class="text-center"><?php echo e($plan->storage_limit); ?>MB</td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                    ...
                    <div class="row gy-5">
                        <div class="col-lg-5">
                            <div class="faq-header">
                                <div class="section-badge mb-3">
                                    <span class="badge-text"><?php echo e($settings['faq_title'] ?: 'FAQ'); ?></span>
                                </div>
                                ...
                                <div class="accordion smart-accordion" id="faqAccordion">
                                    ...
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <div class="accordion-item">
                                            <h3 class="accordion-header" id="faq<?php echo e($i); ?>">
                                                <button class="accordion-button <?php echo e($i == 1 ? '' : 'collapsed'); ?>"
                                                        type="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#faqCollapse<?php echo e($i); ?>"
                                                        aria-expanded="<?php echo e($i == 1 ? 'true' : 'false'); ?>"
                                                        aria-controls="faqCollapse<?php echo e($i); ?>">
                                                    How does SmartHR help streamline HR processes?
                                                </button>
                                            </h3>
                                            <div id="faqCollapse<?php echo e($i); ?>"
                                                 class="accordion-collapse collapse <?php echo e($i == 1 ? 'show' : ''); ?>"
                                                 aria-labelledby="faq<?php echo e($i); ?>"
...
<?php /**PATH /home/mmconnect/Desktop/desktop/my project/SmartHR/irad.smarthr.co.tz/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>