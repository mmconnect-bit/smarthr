    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['casual-attendance.index'], 'method' => 'get', 'id' => 'attendanceemployee_filter'])); ?>
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="<?php echo e(route('casual-attendance.index')); ?>" class="btn btn-sm btn-danger "
                                       ...
                                       <!-- IMPORT BUTTON -->
                                        ...
                                        <!-- EXPORT BUTTON -->
                                        <a href="<?php echo e(route('casual-attendance.file.export')); ?>"
                        ...
                        <table class="table" id="pc-dt-simple">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(_('Main Activity')); ?></th>
                                     <th><?php echo e(_('Activity')); ?></th>
                                ...
                                <?php $__currentLoopData = $attendanceEmployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($attendance->overtime); ?></td>
                                         <td><?php echo e($attendance->activity?->activities?->name); ?></td>
                                         <td><?php echo e($attendance->activity?->name); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mmconnect/Desktop/desktop/my project/SmartHR/irad.smarthr.co.tz/resources/views/casual-attendance/index.blade.php ENDPATH**/ ?>