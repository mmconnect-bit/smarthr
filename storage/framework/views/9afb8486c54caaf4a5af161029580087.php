...
<body class="<?php echo e($themeColor); ?>">
   ...
   <div class="login-bg-img">
    <img src="<?php echo e(asset('assets/images/background-02.jpg')); ?>" alt="Background" class="bg-image" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    ...
                                    <?php endif; ?>
                                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'SmartHR')); ?>
...
<?php /**PATH /home/mmconnect/Desktop/desktop/my project/SmartHR/irad.smarthr.co.tz/resources/views/layouts/auth.blade.php ENDPATH**/ ?>